...
- `pi --version` reports pi 0.80.9 for this cutover baseline.
- `npm ls` shows `@cursor/sdk@1.0.23` and local `@earendil-works/*@0.80.9` packages.
...
- The run uses pi 0.80.9 `--session-id` successfully.
